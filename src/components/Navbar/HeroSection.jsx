...
const HeroSection = () => {
  return (
    ...
    <div className="m-2 space-y-2 md:space-x-3 md:space-y-0 flex flex-col md:flex-row justify-center items-center">
      <button className="px-2 py-1 md:px-6 md:py-2 lg:md:px-7 lg:py-3 bg-black text-white rounded hover:bg-blue-700 w-full md:w-auto text-sm md:text-base lg:text-lg">Buy Now</button>
      <button className="px-2 py-1 md:px-6 lg:md:px-7 md:py-2 lg:py-3 bg-blue-500 text-white rounded hover:bg-blue-700 w-full md:w-auto text-sm md:text-lg lg:text-lg">Know More</button>
    </div>
  </div>
  )
}
