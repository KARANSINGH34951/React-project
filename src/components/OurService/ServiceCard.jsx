...
const ServiceCard = ({ heading, description, img }) => {
  return (
    <div className='text-center bg-[#C9E9D2] p-4 m-2 md:p-6 md:my-6 flex flex-col justify-center items-center h-auto w-full max-w-sm hover:bg-gray-300 transition transform duration-300 hover:scale-110'>
